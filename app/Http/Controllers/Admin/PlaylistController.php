...
class PlaylistController extends Controller
{
    ...
    {
    	$data['playlists'] 		                      = \App\Course::findOrFail($courseId)
                                                            ->playlists()
                                                            ->get();
    ...
    {
        $data                                         = \App\Playlist::where('id',$request->id)
                                                            ->get();
    ...
    public function store(Request $request)
    {
		...
		return \Redirect::back()
                    ->with('sc_msg','Successfuly Adding new Playlist');
    }
    ...
    public function destroy($courseId, $playlistId)
    {
		...
		return \Redirect::back()
                    ->with('sc_msg','Successfuly Delete Playlist');
    }
}
