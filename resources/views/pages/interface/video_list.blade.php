...
@section('body')
	...
	<div class="col-md-12" style="padding:0px;">
		<div class="col-md-8" style="padding:10px;background-color:#eee;border-radius:10px;">
			@if(Auth::check())
			<div class="col-md-12">
		...
		<div class="col-md-4" style="padding:05px;">
			<div class="col-md-12 brand-list" align="center">
				...
				@foreach($data['playlist'] as $index => $playlist)
					...
					<div class="col-md-12 list" style="padding:10px;border-radius:0px;margin-bottom:1px;">
